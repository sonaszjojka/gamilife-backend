...
INSERT INTO "group"."group" (id, join_code, name, admin_id, currency_symbol, members_limit, type_id)
VALUES ('11111111-1111-1111-1111-111111111111', 'FAM123', 'group 1',
       ...
       ('22222222-2222-2222-2222-222222222222', 'FRN456', 'group 2',
        'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '$', 10, 2),
       ('33333333-3333-3333-3333-333333333333', 'WRK789', 'group 3',
        'cccccccc-cccc-cccc-cccc-cccccccccccc', '£', 15, 3);
