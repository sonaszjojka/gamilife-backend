...
public class GroupShopController {
    ...
    public ResponseEntity<ApiResponse> deleteGroupShop(@PathVariable(name="shopId") UUID shopId, @PathVariable(name="groupId") UUID groupId) {
    ...
    @PutMapping("/{shopId}")
    public ResponseEntity<EditGroupShopResponse> editGroupShop(@PathVariable (name = "groupId") UUID groupId ,@PathVariable(name="shopId") UUID shopId, @RequestBody EditGroupShopRequest request) {
