...
public interface JpaAchievementRepository extends JpaRepository<Achievement, UUID> {

    @Query("""
            SELECT new pl.gamilife.gamification.domain.model.projection.UserAchievementDetails(
                a.id,
                a.name,
                a.description,
                a.imagePath,
