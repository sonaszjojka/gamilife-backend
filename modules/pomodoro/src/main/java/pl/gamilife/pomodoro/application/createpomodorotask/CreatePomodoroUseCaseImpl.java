...
public class CreatePomodoroUseCaseImpl implements CreatePomodoroUseCase {
    ...
    public CreatePomodoroTaskResponse execute(UUID taskId, CreatePomodoroTaskRequest request) {
        ...
        PomodoroItem pomodoroItem = createPomodoroTaskMapper.toEntity(request, UUID.randomUUID(), taskId);
        PomodoroItem savedPomodoroItem = pomodoroRepository.save(pomodoroItem);
        return createPomodoroTaskMapper.toResponse(savedPomodoroItem);
    }
}
